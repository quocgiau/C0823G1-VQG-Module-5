...
public class StudentRestController_getListStudent {
    ...
    public void getListStudent_6() throws Exception {
        ...
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("content[4].name").value("Lodemann"))
                .andExpect(jsonPath("content[4].dateOfBirth").value("1998-12-20"))
                .andExpect(jsonPath("content[4].classStudent.id").value(5));
    }
